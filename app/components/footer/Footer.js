...
export default function Footer() {
  return (
    ...
    <footer className={`bg-gray lg:grid lg:grid-cols-5 ${styles.footerP}`}>


  

    <div className={`relative block h-32 lg:col-span-2 lg:h-full ${styles.relativeBlock}`}>
       <Image
          src={FooterImg}
          alt=""
      ...
      <div className={styles.marginResp}></div>
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8"  style={{marginBottom:"30px"}}>
