...
export default function Colaborations() {
  ...
  return (
    <>
      <section > 
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16" style={{ minWidth:"100%"}}>
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16" >
            <div className="mx-auto  text-center lg:mx-0 ltr:lg:text-center rtl:lg:text-right" >
